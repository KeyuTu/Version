...
data = dict(
    ...
    num_workers=4,
    batch_size=5,
    l_anno_file="/data/tuky/DATASET/semi-inat2021/l_train/anno.txt",
    u_anno_file=
    "/data/tuky/DATASET/semi-inat2021/u_train/u_train.txt",
    v_anno_file="/data/tuky/DATASET/semi-inat2021/val/anno.txt",
    mu=7,
