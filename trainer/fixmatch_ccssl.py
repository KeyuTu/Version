...
class FixMatchCCSSL(Trainer):
    ...
    def compute_loss(self,
        ...
        inputs_x_w = inputs_x[0] # inputs_x_w = [16, 3, 32, 32]


        inputs_u, targets_u = data_u
        inputs_u_w, inputs_u_s, inputs_u_s1 = inputs_u
        # inputs_u_w=[112, 3, 32, 32]; inputs_u_s = [112, 3, 32, 32]; inputs_u_s1 = [112, 3, 32, 32]
